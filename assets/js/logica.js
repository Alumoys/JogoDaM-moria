...
const timerDisplay = document.getElementById('tempo'); // Ajustado
const movesDisplay = document.getElementById('movimentos'); // Ajustado
const scoreDisplay = document.getElementById('pontuacao'); // Ajustado
const themeSelect = document.getElementById('theme-select');
const difficultySelect = document.getElementById('difficulty-select');
const playersInfo = document.getElementById('players-info');
const leaderboardBody = document.getElementById('tabeladeclassificacao-corpo'); // Ajustado
